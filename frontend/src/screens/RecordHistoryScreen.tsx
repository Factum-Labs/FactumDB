import { recordHistory, records, reconRows } from '../data/caseData'
import { useApp } from '../store'
import { A } from '../lib/tokens'
  ...
  return (
    <div className="grid max-w-[1180px] items-start gap-4" style={{ gridTemplateColumns: '250px 1fr' }}>
      ...
      <div className="flex flex-col gap-3">
        ...
        <div className="rounded-md border border-line bg-panel px-3.5 pb-3.5 pt-1">
          {rec.steps.map((s, i) => (
            <div
              key={i}
            ...
            >
              <div className="flex flex-col items-center pt-1">
                ...
                <span
                  ...
                  style={{
                    minHeight: 34,
                    background: i === rec.steps.length - 1 ? 'transparent' : '#e2e1dd',
                  }}
                />
              </div>
              <div>
                ...
                <div className="mt-2 flex flex-wrap gap-2">
                  {s.fields.map((f) => (
                    <div
                      ...
                      style={{
                        background: f.highlight ? 'oklch(0.97 0.02 255)' : '#f7f7f5',
                        border: `1px solid ${f.highlight ? 'oklch(0.9 0.04 255)' : '#e7e6e1'}`,
                      }}
                    >
